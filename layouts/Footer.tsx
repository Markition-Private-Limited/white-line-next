      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1fr_auto] lg:grid-cols-[260px_1fr]">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-2.5">
              <SocialIcon href="https://www.facebook.com/profile.php?id=61593680866369" label="Facebook">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
              </SocialIcon>
              <SocialIcon href="https://x.com/whiteline_int" label="Twitter">
              ...
              <SocialIcon href="https://www.linkedin.com/company/whitelineglobal" label="LinkedIn">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg>
              </SocialIcon>
              <SocialIcon href="https://www.instagram.com/whiteline_global" label="Instagram">
