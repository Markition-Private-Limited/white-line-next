      ...
      <section className="relative min-h-screen bg-[#0d0d14]" style={{ borderRadius: 'clamp(14px, 1.5vw, 20px)' }}>
        ...
        <div className="relative z-10 flex min-h-screen flex-col justify-center px-6 pb-10 pt-32 sm:px-10 lg:px-16">
          ...
          >
            ...
            >
              <span style={{ fontWeight: 300 }}>Our Customers</span>
              <br />
              <span style={{ fontWeight: 800, fontStyle: 'italic' }}>Say It Best.</span>
            </motion.h1>
            <motion.p
              className="mb-10 max-w-xl text-sm leading-relaxed text-white/65 sm:text-base"
              style={{ fontFamily: 'Inter, sans-serif' }}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.9, delay: 0.35, ease: 'easeOut' }}
            >
              From airport arrivals to executive journeys, White Line is trusted by
              passengers and businesses who expect more from every mile.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <button
                className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-full font-medium transition-shadow bg-transparent text-white border-2 border-white/60"
                style={{ fontFamily: 'Inter, sans-serif', minWidth: '220px' }}
              >
                <div className="inline-flex h-12 translate-y-0 items-center justify-center gap-2 px-6 transition duration-500 group-hover:-translate-y-[150%] text-white">
                  Read Customer Reviews <ArrowRight size={14} />
                </div>
                <div className="absolute inline-flex h-12 w-full translate-y-[100%] items-center justify-center gap-2 text-white transition duration-500 group-hover:translate-y-0">
                  ...
                  <span className="z-10 inline-flex items-center gap-2">Read Customer Reviews <ArrowRight size={14} /></span>
                </div>
              </button>
            </motion.div>
          </motion.div>
