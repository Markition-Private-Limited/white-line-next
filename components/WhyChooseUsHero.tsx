...
<motion.h1
            ...
            >
              ...
              <span style={{ fontWeight: 800, fontStyle: 'italic' }}>Difference</span>
              <span style={{ fontWeight: 400 }}> Is</span>
              <br />
              <span style={{ fontWeight: 400 }}>In Every Mile.</span>
            </motion.h1>
            <motion.p className="mb-10 max-w-xl text-sm leading-relaxed text-white/70 sm:text-base" style={{ fontFamily: 'Inter, sans-serif' }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, delay: 0.35, ease: 'easeOut' }}>
              White Lane brings together premium chauffeur services and modern technology to
              create a transportation experience built around comfort, reliability, privacy,
