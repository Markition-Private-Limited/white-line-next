  ...
  return (
    <section className="w-full bg-white" style={{ padding: 'clamp(72px, 8vw, 112px) 0' }}>
      <div className="px-6 sm:px-10 lg:px-16">
        ...
        <motion.h2
          {...fadeUp(0.08)}
          className="text-[#111118] leading-tight mb-4"
          style={{
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-12">
          ...
          <motion.div
            ref={imgRef}
            className="w-full lg:w-[52%] flex-shrink-0 overflow-hidden rounded-2xl"
          ...
          >
            <motion.img
              src={_src(customerStoriesImg)}
              alt="Passenger seated in a premium White Line vehicle"
              style={{ y, scale: 1.18 }}
          ...
          >
            <div
              className="w-full flex flex-col justify-center rounded-2xl"
              style={{
                background: '#f6f6f6',
            ...
            >
              ...
              <motion.blockquote
                {...fadeUp(0.28)}
                className="text-[#111118] leading-snug mb-10 flex-1"
                style={{
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 500,
              ...
              >
                "White Line made every part of my journey feel effortless. The chauffeur was
                punctual, discreet and incredibly professional."
              </motion.blockquote>
