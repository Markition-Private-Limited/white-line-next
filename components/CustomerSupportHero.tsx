  ...
  return (
    <div style={{ background: '#ffffff', padding: 'clamp(6px, 0.8vw, 10px)' }}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center px-6 pb-16 pt-36 sm:px-10 lg:px-16"
          style={{ minHeight: 'clamp(420px, 55vw, 680px)' }}
        >
          <motion.div
          ...
          >
            ...
            >
              <span style={{ fontWeight: 300 }}>{"We're Here When"}</span>
              <br />
              <span style={{ fontWeight: 800, fontStyle: 'italic' }}>You Need Us.</span>
            </motion.h1>

            <motion.p
              className="mb-10 max-w-lg text-sm leading-relaxed sm:text-base"
              style={{ fontFamily: 'Inter, sans-serif', color: 'rgba(255,255,255,0.65)' }}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.9, delay: 0.3, ease: 'easeOut' }}
            >
              Professional assistance for all your client support needs. Available 24/7 to handle
              every ticket, journey detail, dispatcher issue and unexpected delay.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <div className="absolute inline-flex h-12 w-full translate-y-[100%] items-center justify-center gap-2 text-white transition duration-500 group-hover:translate-y-0">
                  ...
                  <span className="z-10 inline-flex items-center gap-2">Get Support <ArrowRight size={14} /></span>
                </div>
              </button>
            </motion.div>
          </motion.div>
