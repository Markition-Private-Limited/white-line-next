...
async function fetchRequest<T>(method: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE', path: string, body?: unknown, options: FleetRequestOptions = {}): Promise<FleetHttpResult<T>> {
...
function curlRequest<T>(method: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE', path: string, body?: unknown, options: FleetRequestOptions = {}): Promise<FleetHttpResult<T>> {
...
async function fleetRequest<T>(method: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE', path: string, body?: unknown, options: FleetRequestOptions = {}): Promise<FleetHttpResult<T>> {
  try {
