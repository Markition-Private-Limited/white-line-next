...
const en = {
  ...
  contactPage: {
    ...
    form: {
      ...
      sentBody: 'Thank you for reaching out. A member of our team will get back to you through email shortly.',
      errFirstName: 'First name is required',
      errFirstNameShort: 'First name must be at least 2 characters',
      errFirstNameInvalid: 'First name can only contain letters',
      errFirstNameLong: 'First name must be under 50 characters',
      errLastName: 'Last name is required',
      errLastNameShort: 'Last name must be at least 2 characters',
      errLastNameInvalid: 'Last name can only contain letters',
      errLastNameLong: 'Last name must be under 50 characters',
      errEmail: 'Email address is required',
      errEmailInvalid: 'Enter a valid email address',
      errEmailLong: 'Email must be under 254 characters',
      ...
      errMessageLong: 'Message must be under 2000 characters',
      errDateRequired: 'Preferred date is required',
  ...
  fleetPage: {
    ...
    cars: {
      ...
      title: 'Our Fleet',
      headerDesc: 'Choose from our premium fleet for a comfortable and reliable travel experience.',
      luggages: 'Luggages',
      persons: 'Persons',
      filters: ['All', 'First Class', 'Business Premium', 'SUV', 'Business Sedan', 'Economy Sedan', 'Van'],
      desc: 'Spacious, versatile, and elegant',
      categoryMeta: [
        { title: 'First Class', desc: 'Our most luxurious vehicles for an exceptional travel experience.' },
        { title: 'Business Premium', desc: 'Premium comfort for business and executive travel.' },
        { title: 'SUV', desc: 'Spacious and powerful for both business and family travel.' },
        { title: 'Business Sedan', desc: 'Ideal for professional and corporate travel.' },
        { title: 'Economy Sedan', desc: 'Comfortable and reliable for everyday travel.' },
        { title: 'Van', desc: 'Perfect for group travel with maximum comfort.' },
      ],
    },
  },
...
const ar: typeof en = {
  ...
  contactPage: {
    ...
    form: {
      ...
      sentBody: 'شكراً لتواصلك معنا. سيتواصل معك أحد أعضاء فريقنا عبر البريد الإلكتروني قريباً.',
      errFirstName: 'الاسم الأول مطلوب',
      errFirstNameShort: 'يجب أن يتكون الاسم الأول من حرفين على الأقل',
      errFirstNameInvalid: 'الاسم الأول يجب أن يحتوي على حروف فقط',
      errFirstNameLong: 'الاسم الأول يجب أن يكون أقل من ٥٠ حرفاً',
      errLastName: 'اسم العائلة مطلوب',
      errLastNameShort: 'يجب أن يتكون اسم العائلة من حرفين على الأقل',
      errLastNameInvalid: 'اسم العائلة يجب أن يحتوي على حروف فقط',
      errLastNameLong: 'اسم العائلة يجب أن يكون أقل من ٥٠ حرفاً',
      errEmail: 'البريد الإلكتروني مطلوب',
      errEmailInvalid: 'أدخل بريداً إلكترونياً صحيحاً',
      errEmailLong: 'البريد الإلكتروني يجب أن يكون أقل من ٢٥٤ حرفاً',
      errPhoneInvalid: 'أدخل رقم جوال صحيح',
      errHelpTopic: 'يرجى اختيار خيار',
      errMessage: 'الرسالة مطلوبة',
      errMessageShort: 'يجب أن تتكون الرسالة من ١٠ أحرف على الأقل',
      errMessageLong: 'الرسالة يجب أن تكون أقل من ٢٠٠٠ حرف',
      errDateRequired: 'التاريخ المفضل مطلوب',
      errDatePast: 'لا يمكن اختيار تاريخ في الماضي',
    },
  },
  ...
  fleetPage: {
    ...
    cars: {
      ...
      title: 'أسطولنا',
      headerDesc: 'اختر من أسطولنا المتميز لتجربة سفر مريحة وموثوقة.',
      luggages: 'حقيبة',
      persons: 'راكب',
      ...
      categoryMeta: [
        { title: 'الدرجة الأولى', desc: 'مركباتنا الأكثر فخامة لتجربة سفر استثنائية.' },
        { title: 'درجة الأعمال الممتازة', desc: 'راحة فائقة لرحلات الأعمال والتنفيذيين.' },
        { title: 'SUV', desc: 'فسيحة وقوية لرحلات الأعمال والعائلات.' },
        { title: 'سيدان الأعمال', desc: 'مثالية للسفر المهني والمؤسسي.' },
        { title: 'سيدان اقتصادية', desc: 'مريحة وموثوقة للاستخدام اليومي.' },
        { title: 'فان', desc: 'مثالية للمجموعات مع أقصى قدر من الراحة.' },
      ],
    },
  },
